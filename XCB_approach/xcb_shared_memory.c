// Taken from https://stackoverflow.com/questions/65251904/draw-pixels-in-a-linux-window-without-opengl-in-c
// With XCB it seems like it might be possible to access shared memory space of the windows framebuffer its self
